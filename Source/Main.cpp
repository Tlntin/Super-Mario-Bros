...
//    IOHIDManagerRef managerRef = IOHIDManagerCreate(kCFAllocatorDefault, kIOHIDOptionsTypeNone);
    ...
    // Set the Icon
    sf::Image icon;
    if (!icon.loadFromFile(resourcePath() + "Images/ico.png")) {
        return EXIT_FAILURE;
    }

	sf::Event event;
	sf::Image map_sketch;
	map_sketch.loadFromFile(resourcePath() + "Images/MapSketch.png");
	...
	map_texture.loadFromFile(resourcePath() + "Images/Map.png");
